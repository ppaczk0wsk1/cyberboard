    ...
    >
      <div class="modal" onKeyDown=${onKeyDown}>
        ...
        <input
          ...
          placeholder=${isBookmark ? "e.g. GitHub" : "e.g. Jellyfin"}
          autofocus
        />
        ...
        <input
          ...
          placeholder=${isBookmark
            ? "https://..."
            : "http://service.local:port"}
        />
        ...
        html`
          ...
          <input
            ...
            placeholder="jellyfin media streaming"
          />
        `}
        ${isService &&
        html`
        ...
        <label
          >Icon
          ${icon
            ? html` — preview: <${DynamicIcon} value=${icon} size=${18} />`
            : ""}</label
        >
          ...
          <div class="color-picker">
            ${COLORS.map(
              (c) => html`
                <div
                  key=${c}
                  class="color-opt ic-${c} ${color === c ? "selected" : ""}"
