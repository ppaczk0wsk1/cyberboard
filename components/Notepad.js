    ...
    <div class="notepad">
      ...
      html`
        <div class="notepad-footer">
          ...
          <button
            onClick=${clear}
            style="background:none;border:1px solid var(--border);border-radius:4px;padding:.2rem .5rem;color:var(--text-dim);cursor:pointer;font-size:.7rem;display:flex;align-items:center;gap:.25rem"
          >
