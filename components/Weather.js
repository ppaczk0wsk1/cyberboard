...
function weatherIcon(code) {
  ...
  if ([176,263,266,293,296,299,302,305,308,353,356,359].includes(code)) return WEATHER_ICONS.rain;
  if ([179,182,185,227,230,323,326,329,332,335,338,368,371,374,377,392,395].includes(code)) return WEATHER_ICONS.snow;
    ...
    (async () => {
      try {
        ...
        setWeather({
          ...
          temp: cur.temp_C + '°C',
          desc: cur.weatherDesc[0].value + ' · ' + w.nearest_area[0].areaName[0].value,
        });
      } catch {}
    })();
  }, []);
