export const COLORS = ['blue', 'green', 'orange', 'purple', 'cyan', 'pink', 'red', 'yellow'];

export const CATEGORIES = [
  'productivity', 'media', 'infrastructure', 'security',
  'monitoring', 'development', 'networking', 'storage', 'automation',
];
...
export const ALL_EMOJIS = Object.values(EMOJI_DATA).flat().map(([e]) => e);
